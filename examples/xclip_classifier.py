...
def parse_args():
    ...
    parser.add_argument("--input_path", default="/media/test.webm", help="path to input video .mp4")
...
def main():
    ...
    job_id = client.run_plugin("xclip_classifier", [{"id": data_id, "name": "video"}], [])
    logging.info(f"Job xclip_classifier started: {job_id}")
    ...
    if result is None:
        ...
        return
    logging.info("Plugin results:", result.outputs)
