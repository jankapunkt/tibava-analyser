...
def parse_args():
    ...
    parser.add_argument("--fps", nargs="+", type=int, default=[2, 5, 2], help="fps of input scalar series")
    parser.add_argument("--duration", default=5, help="duration [s] of the signal")
...
def main():
    ...
    job_id = client.run_plugin(
        "aggregate_scalar", [{"id": data_id, "name": "timelines"}], [{"name": "aggregation", "value": "or"}]
    )
