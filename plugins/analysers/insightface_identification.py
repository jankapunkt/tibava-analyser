...
from analyser.data import BboxesData, ImageData, KpssData, ListData, ScalarData, VideoData
...
default_parameters = {"reduction": "max", "fps": 5}

requires = {
    "video": VideoData,
    "bboxes_video": BboxesData,
    "kpss_video": KpssData,
    "image": ImageData,
    "bboxes_image": BboxesData,
    "kpss_image": KpssData,
}
...
@AnalyserPluginManager.export("insightface_identification")
